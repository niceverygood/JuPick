  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        info:
          "border-transparent bg-violet-500 text-white shadow hover:bg-violet-500/80",
        master:
          "border-transparent bg-zinc-900 text-white shadow",
        distributor:
          "border-transparent bg-blue-600 text-white shadow",
        agency:
          "border-transparent bg-cyan-600 text-white shadow",
        user:
          "border-transparent bg-slate-600 text-white shadow",
      },
    },
    defaultVariants: {
      variant: "default",
